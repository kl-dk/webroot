...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:CarePlan">
      <sch:assert test="count(f:extension[@url = 'http://fhir.kl.dk/ffbreporting/StructureDefinition/kl-reporting-ffb-municipalityCaseNumber']) &gt;= 1">extension with URL = 'http://fhir.kl.dk/ffbreporting/StructureDefinition/kl-reporting-ffb-municipalityCaseNumber': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.kl.dk/ffbreporting/StructureDefinition/kl-reporting-ffb-municipalityCaseNumber']) &lt;= 1">extension with URL = 'http://fhir.kl.dk/ffbreporting/StructureDefinition/kl-reporting-ffb-municipalityCaseNumber': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.kl.dk/ffbreporting/StructureDefinition/kl-reporting-ffb-follow-up-date-extension']) &lt;= 1">extension with URL = 'http://fhir.kl.dk/ffbreporting/StructureDefinition/kl-reporting-ffb-follow-up-date-extension': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:CarePlan/f:addresses">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.kl.dk/core/StructureDefinition/ConditionRank']) &gt;= 1">extension with URL = 'http://fhir.kl.dk/core/StructureDefinition/ConditionRank': minimum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:CarePlan/f:addresses/f:extension</sch:title>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:CarePlan/f:activity">
      ...
      <sch:assert test="count(f:outcomeReference) &gt;= 1">outcomeReference: minimum cardinality of 'outcomeReference' is 1</sch:assert>
