...
<%
  ...
  if (s.indexOf("application/json+fhir") > -1) 
    ...
    Response.Redirect("http://fhir.kl.dk/children/2.1.0/Patient-Kirsten.html");
  else if (id == "Rikke")
    Response.Redirect("http://fhir.kl.dk/children/2.1.0/Patient-Rikke.html");
  else if (id == "Lars")
    Response.Redirect("http://fhir.kl.dk/children/2.1.0/Patient-Lars.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from .1.0-milestone\output\crpatient.asp) .
</body>
</html>
