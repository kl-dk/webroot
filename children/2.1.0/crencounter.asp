...
<%
  ...
  if (s.indexOf("application/json+fhir") > -1) 
    ...
    Response.Redirect("http://fhir.kl.dk/children/2.1.0/Encounter-10mthEncounter.html");
  else if (id == "2mthEncounter")
    Response.Redirect("http://fhir.kl.dk/children/2.1.0/Encounter-2mthEncounter.html");
  else if (id == "NeedBasedEncounterRikke")
    Response.Redirect("http://fhir.kl.dk/children/2.1.0/Encounter-NeedBasedEncounterRikke.html");
  else if (id == "2nd1mthEncounter")
    Response.Redirect("http://fhir.kl.dk/children/2.1.0/Encounter-2nd1mthEncounter.html");
  else if (id == "SchoolStartEncounter")
    Response.Redirect("http://fhir.kl.dk/children/2.1.0/Encounter-SchoolStartEncounter.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from \children\2.1.0\crencounter.asp) .
</body>
</html>
