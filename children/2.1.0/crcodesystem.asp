...
<%
  ...
  if (s.indexOf("application/json+fhir") > -1) 
    ...
    Response.Redirect("http://fhir.kl.dk/children/2.1.0/CodeSystem-SNOMED-CT-INT.html");
  else if (id == "LOINC")
    Response.Redirect("http://fhir.kl.dk/children/2.1.0/CodeSystem-LOINC.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from \children\2.1.0\crcodesystem.asp) .
</body>
</html>
