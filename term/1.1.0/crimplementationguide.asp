...
<%
  ...
  if (s.indexOf("application/json+fhir") > -1) 
    ...
    Response.Redirect("http://fhir.kl.dk/term/1.1.0/ImplementationGuide-kl.dk.fhir.term.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from /term/1.1.0/crimplementationguide.asp) .
</body>
</html>
