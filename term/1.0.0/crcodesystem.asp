...
<%
  ...
  if (s.indexOf("application/json+fhir") > -1) 
    ...
    Response.Redirect("http://fhir.kl.dk/term/1.0.0/CodeSystem-FFB.html");
  else if (id == "CareSocialCodes")
    Response.Redirect("http://fhir.kl.dk/term/1.0.0/CodeSystem-CareSocialCodes.html");
  else if (id == "KLCommonproprietary")
    Response.Redirect("http://fhir.kl.dk/term/1.0.0/CodeSystem-KLCommonproprietary.html");
  else if (id == "FSIII")
    Response.Redirect("http://fhir.kl.dk/term/1.0.0/CodeSystem-FSIII.html");
  else if (id == "NPU")
    Response.Redirect("http://fhir.kl.dk/term/1.0.0/CodeSystem-NPU.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from /term/1.0.0/crcodesystem.asp) .
</body>
</html>
