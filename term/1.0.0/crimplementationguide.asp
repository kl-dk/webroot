...
<%
  ...
  else if (id == "kl.fhir.dk.term")
    Response.Redirect("http://fhir.kl.dk/term/1.0.0/ImplementationGuide-kl.fhir.dk.term.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from /term/1.0.0/crimplementationguide.asp) .
</body>
</html>
