...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:CarePlan">
      <sch:assert test="count(f:extension[@url = 'http://fhir.kl.dk/prevention/StructureDefinition/BasedOnServiceRequestExtension']) &lt;= 1">extension with URL = 'http://fhir.kl.dk/prevention/StructureDefinition/BasedOnServiceRequestExtension': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:CarePlan/f:activity/f:detail">
      <sch:assert test="count(f:extension[@url = 'http://fhir.kl.dk/prevention/StructureDefinition/DeliveryType']) &gt;= 1">extension with URL = 'http://fhir.kl.dk/prevention/StructureDefinition/DeliveryType': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.kl.dk/prevention/StructureDefinition/DeliveryType']) &lt;= 1">extension with URL = 'http://fhir.kl.dk/prevention/StructureDefinition/DeliveryType': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:CarePlan/f:activity/f:detail/f:extension/f:value[x] 1</sch:title>
    <sch:rule context="f:CarePlan/f:activity/f:detail/f:extension/f:value[x]">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
