...
<%
  ...
  if (s.indexOf("application/json+fhir") > -1) 
    ...
    Response.Redirect("http://fhir.kl.dk/prevention/2.0.0/index.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from #2.0.0-milestone\output\crimplementationguide.asp) .
</body>
</html>
