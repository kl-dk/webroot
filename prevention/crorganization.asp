...
<%
  ...
  if (s.indexOf("application/json+fhir") > -1) 
    ...
    Response.Redirect("http://fhir.kl.dk/prevention/2.1.1/Organization-AfsenderAfBrunosHenvisning.html");
  else if (id == "UdfoererAfBrunosForebyggelse")
    Response.Redirect("http://fhir.kl.dk/prevention/2.1.1/Organization-UdfoererAfBrunosForebyggelse.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from #2.1.1-milestone\output\crorganization.asp) .
</body>
</html>
