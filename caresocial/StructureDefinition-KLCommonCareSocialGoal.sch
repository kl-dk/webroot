...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:Goal/f:extension/f:extension</sch:title>
    <sch:rule context="f:Goal/f:extension/f:extension">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:url) &gt;= 1">url: minimum cardinality of 'url' is 1</sch:assert>
      <sch:assert test="count(f:url) &lt;= 1">url: maximum cardinality of 'url' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Goal/f:extension/f:extension/f:value[x] 1</sch:title>
    <sch:rule context="f:Goal/f:extension/f:extension/f:value[x]">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Goal/f:addresses">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://kl.dk/fhir/common/caresocial/StructureDefinition/ConditionRank']) &lt;= 1">extension with URL = 'http://kl.dk/fhir/common/caresocial/StructureDefinition/ConditionRank': maximum cardinality of 'extension' is 1</sch:assert>
