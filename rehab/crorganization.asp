...
<%
  ...
  if (s.indexOf("application/json+fhir") > -1) 
    ...
    Response.Redirect("http://fhir.kl.dk/rehab/2.1.1/Organization-UdfoererAfRuddisRehab.html");
  else if (id == "AfsenderAfRuddisGGOP")
    Response.Redirect("http://fhir.kl.dk/rehab/2.1.1/Organization-AfsenderAfRuddisGGOP.html");
  else if (id == "7fdd6dc0-3f9f-4914-b34a-7c6495ba0880")
    Response.Redirect("http://fhir.kl.dk/rehab/2.1.1/Organization-7fdd6dc0-3f9f-4914-b34a-7c6495ba0880.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from 1-milestone\output\crorganization.asp) .
</body>
</html>
