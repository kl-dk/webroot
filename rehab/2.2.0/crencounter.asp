...
<%
  ...
  if (s.indexOf("application/json+fhir") > -1) 
    ...
    Response.Redirect("http://fhir.kl.dk/rehab/2.2.0/Encounter-RuddiKontakt1Traening.html");
  else if (id == "RuddiKontaktUndersoegelse")
    Response.Redirect("http://fhir.kl.dk/rehab/2.2.0/Encounter-RuddiKontaktUndersoegelse.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from \rehab\2.2.0\crencounter.asp) .
</body>
</html>
