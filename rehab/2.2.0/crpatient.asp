...
<%
  ...
  if (s.indexOf("application/json+fhir") > -1) 
    ...
    Response.Redirect("http://fhir.kl.dk/rehab/2.2.0/Patient-RuddiTestBerggren.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from \rehab\2.2.0\crpatient.asp) .
</body>
</html>
