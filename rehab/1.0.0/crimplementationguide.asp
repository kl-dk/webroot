...
<%
  ...
  if (s.indexOf("application/json+fhir") > -1) 
    ...
    Response.Redirect("http://fhir.kl.dk/rehab/1.0.0/ImplementationGuide-kl.dk.fhir.rehab.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from /rehab/1.0.0/crimplementationguide.asp) .
</body>
</html>
