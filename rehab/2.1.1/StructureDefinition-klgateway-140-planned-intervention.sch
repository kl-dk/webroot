...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:CarePlan">
      <sch:assert test="count(f:extension[@url = 'http://fhir.kl.dk/rehab/StructureDefinition/BasedOnServiceRequestExtension']) &lt;= 1">extension with URL = 'http://fhir.kl.dk/rehab/StructureDefinition/BasedOnServiceRequestExtension': maximum cardinality of 'extension' is 1</sch:assert>
