...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:ServiceRequest">
      <sch:assert test="count(f:extension[@url = 'http://fhir.kl.dk/core/StructureDefinition/RequesterType']) &lt;= 1">extension with URL = 'http://fhir.kl.dk/core/StructureDefinition/RequesterType': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.kl.dk/core/StructureDefinition/SubjectConsentToLiaising']) &lt;= 1">extension with URL = 'http://fhir.kl.dk/core/StructureDefinition/SubjectConsentToLiaising': maximum cardinality of 'extension' is 1</sch:assert>
